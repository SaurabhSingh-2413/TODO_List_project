...
<body>
	...
	<table class="table table-striped table-light">
		<h1 class="text-center">:Searched-Data:</h1>
		<thead>
			<tr>
				<th scope="col">ID</th>
		...
		String srch = request.getParameter("srch1");
		
		String fetch = "from Notes where title=:x";
		Query q = s.createQuery(fetch);
		q.setParameter("x", srch);
		...
		<tbody>
			<tr>
				<td><%=n.getId()%></td>
				<td><%=n.getTitle()%></td>
				<td><%=n.getCurrentDate()%></td>
				<td><%=n.getContent()%></td>
		
				<td><a href="Edit.jsp?id=<%out.print(n.getId());%>"><i
						class="fa-solid fa-pen-to-square fa-xl icon1"
						style="color: #80cbc4;"></i></a></td>
				<td><a href="Delete.jsp?id=<%out.print(n.getId());%>"><i
